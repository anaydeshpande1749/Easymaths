...
public class AlgebraQuiz extends JFrame {
    ...
    public AlgebraQuiz(String username, int userId, String topic) {
        this.username = username;
        this.userId = userId;
        this.topic = topic;

        this.topicId = getTopicId(topic); // Add this line
...
//            String sql = "SELECT score FROM user_scores WHERE user_id = ? AND topic_id = ?";
